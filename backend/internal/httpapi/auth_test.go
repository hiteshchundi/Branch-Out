...
func authTestAPI(authentication Authenticator, options Options) http.Handler {
	return New(
		openings.NewMemoryRepository(nil), fakeOpeningManager{}, fakeApplicationManager{}, fakeTrialProposalManager{}, fakeSafetyManager{}, readyChecker{}, authentication, fakeProfileManager{}, options,
