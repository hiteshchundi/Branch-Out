...
func applicationTestAPI(manager fakeApplicationManager, authentication fakeAuthenticator) http.Handler {
	return New(nil, fakeOpeningManager{}, manager, fakeTrialProposalManager{}, fakeSafetyManager{}, readyChecker{}, authentication, fakeProfileManager{}, defaultOptions, testLogger())
}
